...
public class MainPageController {
    ...
    public void playMouseExitAnimation(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView) {
            ImageView icon = (ImageView) event.getSource();
            ScaleTransition scaleT = new ScaleTransition(Duration.millis(200), icon);
            scaleT.setToX(1);
    ...
    private void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgCustomer":
                    root = FXMLLoader.load(this.getClass().getResource("../view/mangeCustomerFrom.fxml"));
                    break;
                case "imgItem":
                    root = FXMLLoader.load(this.getClass().getResource("../view/item.fxml"));
                    break;
                case "imgPlaceOrder":
                    root = FXMLLoader.load(this.getClass().getResource("../view/placeOderFrom.fxml"));
                    break;
                case "imgViewOrders":
                    root = null;
                    break;
